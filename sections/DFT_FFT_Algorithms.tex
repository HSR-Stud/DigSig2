...
This polynom can be evaluated using \emph{Hörner's rule}:
...
Adding any number of zeros to the end of a signal does \emph{not} change its DFT!
\begin{align*}
...
\subsection{Physical vs Computional Resolution\buchSeite{482-485}}
...
Some examples of twiddle factors and DFT matrices:
...
or even graphically:
\begin{center}
	\includegraphics[width=0.6\linewidth]{images/DFT_FFT_butterfly.jpg}
\end{center}
...
The multiplication of two DTFTs results in a convolution
\begin{equation*}
...
\begin{center}
	\includegraphics[width=\linewidth]{images/DFT_FFT_overlapSave.jpg}
\end{center}